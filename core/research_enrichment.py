...
class ResearchEnricher:
    ...
    def extract_entities(self, wisdom: str, transcript: str, ai_model: str = "gpt-3.5-turbo") -> List[Dict[str, Any]]:
...
Be selective - only include entities that would genuinely benefit from research links to enhance understanding."""
    ...
    def generate_research_links(self, entities: List[Dict[str, Any]], ai_model: str = "gpt-3.5-turbo") -> List[Dict[str, Any]]:
...
Focus on REAL, authoritative sources. If you cannot suggest specific URLs, provide realistic examples of what types of sources would be valuable."""
    ...
    def enrich_content(self, wisdom: str, transcript: str, ai_model: str = "gpt-3.5-turbo") -> Dict[str, Any]:
