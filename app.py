...
# Define fallback API key using the environment variable, not hardcoded
...
def show_main_page():
    ...
    st.markdown("## 🎤 WhisperForge: Live Reloading Demo")
    st.markdown("This is a demonstration of live code reloading. Any changes to the code are automatically reflected in the browser.")
    
    # Create input tabs (Audio Upload / Manual Text)
    input_tabs = st.tabs(["🎙️ Audio Upload", "📝 Text Input"])
...
def create_custom_header():
    ...
    <div class="header-container">
        <div class="header-left">
            <div class="header-title">WhisperForge // LIVE DEMO</div>
        </div>
